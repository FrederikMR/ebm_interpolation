from utils.dataloader import AlphaNum, AlphaNumV2, ImageLoader#, ImageLoader_amb
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/work3/fmry/Data/afhq/stargan-v1/data/")
